...
@interface LPTrackGeofenceApiTest : XCTestCase

@end

@implementation LPTrackGeofenceApiTest
...
- (void)testTrackGeofenceApiWithHttpError {
    XCTestExpectation *expectation = [self expectationWithDescription:@"Query timed out."];
...
- (void)testTrackGeofenceApiWithParametersStub {
    [LPTestHelper setupStub:200 withFileName:@"simple_post_success_response.json"];
    XCTestExpectation *expectation = [self expectationWithDescription:@"Query timed out."];
    NSDictionary *params = @{@"testKey": @"testValue" };
    LPGeofenceEventType event = LPEnterRegion;
