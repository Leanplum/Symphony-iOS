...
+ (void)swizzle_methods
{
    ...
    bool success = [LPSwizzle swizzleClassMethod:@selector(pauseSessionWithParameters:success:failure:)
                             withClassMethod:@selector(swizzle_pauseSessionWithParameters:success:failure:)
                                       error:&error
